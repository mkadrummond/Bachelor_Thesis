...
%%     $Id: MDT-SADA.tex 263 2009-03-18 08:44:23Z emspmdt\dietmarw $
%%**************************************************************
%% (The "Id" tag above is updated automatically if
%% 	svn propset svn:keywords "Id" <filename>
%% was set.)
\documentclass[index,openany]{MDT-SADA}
...
\newcommand{\umgebung}[2][x]{\ifthenelse{\equal{#1}{x}}{\index{Umgebung!#2}\index{#2}}{}\texttt{#2}}
...
\begin{document}
 ...
 %Erzeugen der Seite mit den Abkürzungen
    ...
    \chapter{Einleitung}
        ...
        Bei Fragen zu oder Problemen mit dieser Vorlage, wenden sie sich bitte an das Sekretariat des Fachgebiets MDT.
        Hier wird man Sie an den aktuellen Ansprechpartner weiterleiten.

        \url{http://www.mdt.tu-berlin.de/kontakt}
    ...
    \chapter{Installation}
        ...
        \begin{itemize}
          \item \texttt{scrbook, scrpage2} (Koma-Skript Klassen: \url{http://www.komascript.de/release})
...
Alle aufgeführten Pakete sind entweder schon in den Standard-\LaTeX-Distributionen (MiK\TeX , te\TeX , \TeX Live) enthalten bzw. lassen sich leicht nachinstallieren.
    ...
    \chapter{Einsatz}
        \section{Allgemeines}
            ...
            \lstinputlisting[linerange={8-8,33-33,35-35,38-41,44-44,47-50,53-55,62-62,65-65,68-68,265-266}]{MDT-SADA.tex}%
...
Allgemein gibt es außerdem bei den Befehlen \befehl[no]{bild} und \befehl[no]{doppelbild} noch die Möglichkeit die Plazierung durch ein Optionales Plazierungsargument zu steuern.
    ...
    \begin{beispiel}{}
            ...
            \subsection{Literaturverzeichnis}
                Für das Literaturverzeichnis steht die Umgebung \umgebung{literaturverzeichnis} zur Verfügung.
                Sie wird durch die beiden Befehle \befehl[no]{begin\{literaturverzeichnis\}} und \befehl[no]{end\{literaturverzeichnis\}} begrenzt.
                Innerhalb der Umgebung werden die einzelnen Literaturverweise mit dem Befehl \befehl{bibitem} gesetzt.

                \begin{beispiel}{260-262}
